...
public class HealthMeasureHistory implements Serializable {
	...
	public static List<HealthMeasureHistory> getPeopleHistory(Long idPerson,Integer idMeasureDef){
		EntityManager em = LifeCoachDao.instance.createEntityManager();
	...
	public static HealthMeasureHistory getValueMeasureHistory(Long idPerson, Integer idMeasureDef, Long idMeasureHistory){
		EntityManager em = LifeCoachDao.instance.createEntityManager();
		
		Query query=em.createQuery("SELECT h FROM HealthMeasureHistory h WHERE h.idMeasureHistory=:idMeasureHistory AND h.idMeasureDef=:idMeasureDef AND h.idPerson=:idPerson", HealthMeasureHistory.class);
